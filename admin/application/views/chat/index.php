        ...
        <div class="card">
                        <div class="card-header msg_head">
                            <div class="d-flex bd-highlight">
                                <div class="img_cont">
                                    <img src="<?= base_url(); ?>assets/user_profile/user2.png" class="rounded-circle user_img">
                                    <span class="online_icon"></span>
                                </div>
                                <div class="user_info">
                                    <span><?= $chat_with['username']; ?></span>
                                    <a  href="<?=base_url()."/chat/getalluser"?>" class="btn btn-secondary">Back</a>
                                </div>
                        ...
                        <div class="card-body msg_card_body">
                            <?php foreach ($message as $mkey => $mval): ?>
                                <?php if ($mval['sender_id'] !== $this->session->userdata['user_data']['user_id']) { ?>
                                    <div class="d-flex justify-content-start mb-4">
                                        <div class="img_cont_msg">
                                            <img src="<?= base_url(); ?>assets/image/user.png" class="rounded-circle user_img_msg">
                                        </div>
                                ...
                                <?php } else { ?>
                                    <div class="d-flex justify-content-end mb-4">
                                        ...
                                        <div class="img_cont_msg">
                                            <img src="<?= base_url(); ?>assets/image/user3.png" class="rounded-circle user_img_msg">
                                        </div>
                                    </div>
                                <?php } ?>
                            <?php endforeach; ?>
