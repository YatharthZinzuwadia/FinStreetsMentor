			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<?php } ?>
						<form role="form" id="payForm" action="<?php echo base_url('handleStripePayment');?>" method="post"
	...
	$(function () {
		...
		$('form.form-validation').bind('submit', function (e) {
			...
			if (!$stripeForm.data('cc-on-file')) {
				e.preventDefault();
				Stripe.setPublishableKey('pk_test_51MdsUwSDCr6tEF9p5U3tpr2a2QBWDOK80xKg7xHfNkWYm4EBU1TKDvtKoThC700d6Q9T59vDTv1mAJEVwnhYVOXZ00DZKgtqEI');
                $stripeForm.data('pk_test_51MdsUwSDCr6tEF9p5U3tpr2a2QBWDOK80xKg7xHfNkWYm4EBU1TKDvtKoThC700d6Q9T59vDTv1mAJEVwnhYVOXZ00DZKgtqEI');
				Stripe.createToken({
